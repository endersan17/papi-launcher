...
public final class Config implements Observable {
    ...
    @SerializedName("customCssPath")
    private StringProperty customCssPath = new SimpleStringProperty();
    ...
    @SerializedName("transparentEffect")
    private BooleanProperty transparentEffect = new SimpleBooleanProperty(true);
    ...
    @SerializedName("addedElyBy")
    private BooleanProperty addedElyBy = new SimpleBooleanProperty(false);
    ...
    @SerializedName("discordRpcEnabled")
    private final BooleanProperty discordRpcEnabled = new SimpleBooleanProperty(this, "discordRpcEnabled", true);
    ...
    public String getCustomCssPath() {
        return customCssPath.get();
    }

    public void setCustomCssPath(String customCssPath) {
        this.customCssPath.set(customCssPath);
    }

    public StringProperty customCssPathProperty() {
    ...
    public boolean isAddedElyBy() {
        return addedElyBy.get();
    }

    public BooleanProperty addedElyByProperty() {
        return addedElyBy;
    }

    public void setAddedElyBy(boolean addedElyBy) {
        this.addedElyBy.set(addedElyBy);
    }
    ...
    public boolean isDiscordRpcEnabled() {
        return discordRpcEnabled.get();
    }

    public BooleanProperty discordRpcEnabledProperty() {
        return discordRpcEnabled;
    }

    public void setDiscordRpcEnabled(boolean value) {
        this.discordRpcEnabled.set(value);
    }
    ...
    public boolean isTransparentEffect() {
        return transparentEffect.get();
    }

    public void setTransparentEffect(boolean transparentEffect) {
        this.transparentEffect.set(transparentEffect);
    }

    public BooleanProperty transparentEffectProperty() {
