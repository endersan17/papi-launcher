...
public class RootPage extends DecoratorAnimatedPage implements DecoratorPage {
    ...
    private static class Skin extends DecoratorAnimatedPageSkin<RootPage> {
        ...
        protected Skin(RootPage control) {
            ...
            AdvancedListItem containerItem = new AdvancedListItem();
            containerItem.setLeftGraphic(wrap(SVG.FOLDER));
            containerItem.setActionButtonVisible(false);
            containerItem.setTitle(i18n("container.manage"));
            containerItem.setOnAction(e -> Controllers.navigate(Controllers.getContainerListPage()));
