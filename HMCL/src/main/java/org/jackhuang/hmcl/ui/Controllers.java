...
import org.jackhuang.hmcl.ui.container.ContainerListPage;
...
public final class Controllers {
    ...
    private static Lazy<ContainerListPage> containerListPage = new Lazy<>(ContainerListPage::new);
    ...
    // FXThread
    public static ContainerListPage getContainerListPage() {
        return containerListPage.get();
    }
    ...
    public static void initialize(Stage stage) {
        ...
        if (globalConfig().getAgreementVersion() < 1) {
            ...
            agreementPane.setStyle("-fx-background-color: #0A0A0F;");
