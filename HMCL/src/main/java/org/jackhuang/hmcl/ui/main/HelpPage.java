...
public class HelpPage extends SpinnerPane {
    ...
    public HelpPage() {
        ...
        {
            IconedTwoLineListItem papiDocPane = new IconedTwoLineListItem();
            papiDocPane.setTitle(i18n("help.papi_doc"));
            papiDocPane.setSubtitle(i18n("help.papi_doc.detail"));
            papiDocPane.setExternalLink(Metadata.PAPI_WEBSITE_URL);

            IconedTwoLineListItem hmclDocPane = new IconedTwoLineListItem();
            hmclDocPane.setTitle(i18n("help.hmcl_doc"));
            hmclDocPane.setSubtitle(i18n("help.hmcl_doc.detail"));
            hmclDocPane.setExternalLink(Metadata.DOCS_URL);

            doc.getContent().setAll(papiDocPane, hmclDocPane);
        }
